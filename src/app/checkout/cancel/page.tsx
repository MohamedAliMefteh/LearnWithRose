      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className={`transition-all duration-1000 ${isAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-slate-900 mb-3">Payment Canceled</h1>
            <p className="text-xl text-slate-600">No worries, you can try again anytime</p>
          </div>
          ...
          <Card className="mb-8 border-0 shadow-xl bg-gradient-to-br from-white to-slate-50">
            <CardHeader className="bg-gradient-to-r from-orange-500 to-red-500 text-white p-6">
              <div className="text-center">
                ...
                <p className="text-orange-100">Your payment was canceled and no charges were made</p>
              </div>
            </CardHeader>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
                  <div className="flex items-start gap-3">
                    <XCircle className="w-6 h-6 text-orange-500 mt-0.5" />
                    <div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900 mb-2">What can you do next?</h4>
